...
public class DlgKamarInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-09-2023" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-09-2023" }));
                        ...
                        try {
                              ...
                              if(rs2.next()){
                                    ...
                                    Valid.MyReportqry("rptBarcodeRawat.jasper","report","::[ Barcode No.Rawat ]::",
                                        "select reg_periksa.no_rawat,pasien.jk FROM reg_periksa LEFT JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis "+
                                        "where no_rawat='"+rs2.getString("no_rawat2")+"'",param);
                                    this.setCursor(Cursor.getDefaultCursor());
                              }else{
                                  JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
                                  tbKamIn.requestFocus();
            ...
            if(tbKamIn.getSelectedRow()>-1){
                if(tbKamIn.getValueAt(tbKamIn.getSelectedRow(),0).toString().equals("")){
                    try {
                        ...
                        try {
                            ...
                            if(rs2.next()){
                                ...
                                param.put("hubungan",Sequel.cariIsi("select pasien.keluarga from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));
                                ...
                                param.put("cara_bayar",Sequel.cariIsi("SELECT penjab.png_jawab FROM reg_periksa LEFT JOIN penjab ON reg_periksa.kd_pj = penjab.kd_pj Where no_rawat =?", TNoRwCari.getText()));
                                param.put("dokter_asal",Sequel.cariIsi("SELECT dokter.nm_dokter FROM reg_periksa LEFT JOIN dokter ON dokter.kd_dokter = reg_periksa.kd_dokter where reg_periksa.no_rawat=?",TNoRwCari.getText()));
                                param.put("kamar", Sequel.cariIsi("SELECT bangsal.nm_bangsal FROM reg_periksa RIGHT JOIN kamar_inap ON reg_periksa.no_rawat = kamar_inap.no_rawat R IGHT JOIN kamar ON kamar.kd_kamar = kamar_inap.kd_kamar RIGHT JOIN bangsal ON kamar.kd_bangsal = bangsal.kd_bangsal where reg_periksa.no_rawat=?",TNoRwCari.getText()));
                    ...
                    if(TNoRMCari.getText().trim().equals("")){
                        ...
                        param.put("cara_bayar",Sequel.cariIsi("SELECT penjab.png_jawab FROM reg_periksa LEFT JOIN penjab ON reg_periksa.kd_pj = penjab.kd_pj Where no_rawat =?", TNoRwCari.getText()));
                        param.put("dokter_asal",Sequel.cariIsi("SELECT dokter.nm_dokter FROM reg_periksa LEFT JOIN dokter ON dokter.kd_dokter = reg_periksa.kd_dokter where reg_periksa.no_rawat=?",TNoRwCari.getText()));
                        param.put("kamar", Sequel.cariIsi("SELECT bangsal.nm_bangsal FROM reg_periksa RIGHT JOIN kamar_inap ON reg_periksa.no_rawat = kamar_inap.no_rawat RIGHT JOIN kamar ON kamar.kd_kamar = kamar_inap.kd_kamar RIGHT JOIN bangsal ON kamar.kd_bangsal = bangsal.kd_bangsal where reg_periksa.no_rawat=?",TNoRwCari.getText()));
