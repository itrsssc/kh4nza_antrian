...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    ...
    */
    ...
    private static transient widget.TextBox AlamatAsuransi;
    private static transient widget.TextBox AtasNama;
    private static transient widget.Button BtnAll;
    private static transient widget.Button BtnCari;
    private static transient widget.Button BtnKeluar;
    private static transient widget.Button BtnPrint;
    private static transient widget.Button BtnRefreshPhoto;
    private static transient widget.CekBox ChkAccor;
    private static transient widget.CekBox ChkInput;
    private static transient widget.panelisi FormInput;
    private static transient widget.PanelBiasa FormPass2;
    private static transient widget.PanelBiasa FormPhoto;
    private static transient widget.TextBox KdAkun;
    private static transient widget.TextBox KdPeg;
    private static transient widget.Label LTotal;
    private static transient widget.editorpane LoadHTML;
    private static transient widget.TextBox NamaBank;
    private static transient widget.TextBox NmPeg;
    private static transient widget.TextBox NoPenagihan;
    private static transient widget.TextBox NoRek;
    private static transient widget.TextBox NoTelp;
    private static transient widget.PanelBiasa PanelAccor;
    private static transient javax.swing.JPanel PanelInput;
    private static transient widget.TextBox Perusahaan;
    private static transient widget.ScrollPane Scroll4;
    private static transient widget.ComboBox Status;
    private static transient widget.TextBox TCari;
    private static transient widget.Tanggal Tanggal1;
    private static transient widget.Tanggal Tanggal2;
    private static transient widget.Button btnAmbilPhoto;
    private static transient widget.Button btnBarang;
    private static transient widget.Button btnPetugas;
    private static transient widget.Button btnSuplier;
    private static transient widget.InternalFrame internalFrame1;
    private static transient javax.swing.JPopupMenu jPopupMenu1;
    private static transient widget.TextBox kdpenjab;
    private static transient widget.Label label10;
    private static transient widget.Label label11;
    private static transient widget.Label label12;
    private static transient widget.Label label13;
    private static transient widget.Label label14;
    private static transient widget.Label label15;
    private static transient widget.Label label16;
    private static transient widget.Label label17;
    private static transient widget.Label label9;
    private static transient widget.TextBox nmpenjab;
    private static transient widget.panelisi panelisi1;
    private static transient javax.swing.JMenuItem ppDisetujui;
    public static final transient javax.swing.JMenuItem ppHapus = new javax.swing.JMenuItem();
    private static transient javax.swing.JMenuItem ppTidakDisetujui;
    private static transient javax.swing.JMenuItem ppVerifikasi;
    private static transient widget.ScrollPane scrollPane1;
    private static transient widget.Table tbDokter;
    ...
    public void isCek(){
        ...
        if(akses.getkode().equals("06.28.804")){
            ppHapus.setEnabled(true);
        }
        if(akses.getkode().equals("09.15.898")){
            ppHapus.setEnabled(true);
        }else{
